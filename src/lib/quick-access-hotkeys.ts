...
export const QUICK_ACCESS_HOTKEYS: HotkeyDef[] = [
  ...
  { keys: 'G C', label: 'Сообщения', href: '/messages', group: 'account' },
  { keys: 'G R', label: 'Друзья', href: '/friends', group: 'account' },
  { keys: 'G D', label: 'Профиль', href: '/dashboard', group: 'account' },
  { keys: 'G U', label: 'Настройки', href: '/dashboard/settings', group: 'account' },
  { keys: 'G A', label: 'Достижения', href: '/dashboard/achievements', group: 'account' },
