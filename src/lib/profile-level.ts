 ...
 * Вклад = мбаллы на руках + стоимость косметики + ценность коллекции.
...
const LEVELS: Omit<ProfileLevel, 'next'>[] = [
  ...
  },
  {
    ...
    min: 120,
    band: 'bay',
    reward: { eco: 18, perk: 'Бонус мбаллов за активность' },
  },
  {
    level: 5,
    id: 'activist',
  ...
  },
  {
    ...
    min: 480,
    band: 'horizon',
    reward: { eco: 40, perk: 'Премиум-пакет мбаллов за ранг' },
  },
  {
    level: 8,
    id: 'keeper',
  ...
  },
  {
    ...
    min: 1000,
    band: 'summit',
    reward: { eco: 70, perk: 'Капитанский бонус мбаллов' },
  },
  {
    level: 10,
    id: 'legend',
