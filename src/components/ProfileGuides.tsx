...
const GUIDES: GuideDef[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'За фото растёт соцрейтинг и начисляются эко-баллы.',
    ],
  },
  {
    id: 'reliability',
  ...
  },
  {
    ...
    module: 'eco',
    steps: [
      'Эко-баллы за активность: чекин, друзья, галерея, инструктаж, вакансии, конкурсы и игры.',
      'В профиле — каталог рамок и значков за эко-баллы.',
      'История начислений — во вкладке «Эко» в модалке репутации.',
    ],
  },
  {
    id: 'entities',
